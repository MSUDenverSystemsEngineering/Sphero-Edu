...
Try {
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		# Misc cmdlets to get package info if you need it.
		#(Get-AppxPackage -AllUsers -Name "Microsoft.VCLibs.140.00").Version
		#Get-AppxPackage -AllUsers -Name "Microsoft.VCLibs.140.00.UWPDesktop"
		#Get-AppxPackage -AllUsers -Name "Microsoft.WindowsAppRuntime.1.0"
		Write-Log -Message "Installing Microsoft.VCLibs.x64.14.00..." -Source 'Installation' -LogType 'CMTrace'
		$exitCode = Add-AppxProvisionedPackage -Online -SkipLicense -PackagePath $dirFiles\Microsoft.VCLibs.140.00_14.0.30704.0_x64__8wekyb3d8bbwe.Appx
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
		Write-Log -Message "Installing Microsoft.VCLibs.x64.14.00.Desktop..." -Source 'Installation' -LogType 'CMTrace'
		$exitCode = Add-AppxProvisionedPackage -Online -SkipLicense -PackagePath $dirFiles\Microsoft.VCLibs.140.00.UWPDesktop_14.0.30704.0_x64__8wekyb3d8bbwe.Appx
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
		Write-Log -Message "Installing WinAppSDK..." -Source 'Installation' -LogType 'CMTrace'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Write-Log -Message "Removing Sphero Edu..." -Source 'Uninstallation' -LogType 'CMTrace'
		$exitCode = Get-AppxPackage -AllUsers -PackageTypeFilter Bundle -Name "C7085897.SpheroEdu" | Remove-AppxPackage -AllUsers
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
